...
fn main() {
    ...
    // Specifying generic type parameters, trait bounds and lifetimes together
    let la = longest_announcement("long string", "xyz", "My Attention!");

    println!("Longest announcement: {}", la);
}
